...
public class CGPEvolve extends GeneticAlgorithm<CGPChromosome> {
    ...
    public CGPEvolve(@NonNull Initializer<CGPChromosome> initializer,
        ...
        this.addTerminateListener(env -> {
            ...
            if (params.getUpdateFrequency() != 0 && (env.getGeneration() % params.getUpdateFrequency() == 0)) {
    ...
    public Results repeatEvolve(CGPParams params,
                                int numGens,
                                int numRuns,
                                CGPChromosome... chromosomes) throws ExecutionException, InterruptedException {
    ...
    @Override
    public Population<CGPChromosome> evolvePopulation() throws ExecutionException, InterruptedException {
     ...
     *
     * @param chromosomes user input chromosone
     */
    public void injectPrevPopulation(CGPChromosome[] chromosomes) {
        MutableList<CGPChromosome> prevPopulation = org.eclipse.collections.api.factory.Lists.mutable.ofAll(Arrays.asList(chromosomes));
