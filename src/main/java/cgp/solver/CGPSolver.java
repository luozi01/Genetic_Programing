...
public class CGPSolver {
  ...
  public CGPSolver(
      final int numInputs, final int numNodes, final int numOutputs, final int nodeArity) {
  ...
  public void setData(@NonNull DataSet data) {
    if (params.getNumInputs() != data.getNumInputs()) {
      throw new IllegalArgumentException(
          String.format(
              "The number of inputs specified in the dataSet (%d) does not match the number of inputs specified in the parameters (%d).",
              data.getNumInputs(), params.getNumInputs()));
    }

    if (params.getNumOutputs() != data.getNumOutputs()) {
      throw new IllegalArgumentException(
          String.format(
              "The number of outputs specified in the dataSet (%d) does not match the number of outputs specified in the parameters (%d).",
              data.getNumOutputs(), params.getNumOutputs()));
    }
  ...
  /**
   * Sets the mu value in given parameters to the new given value. If mu value is invalid a warning
   * is displayed and the mu value is left unchanged.
   */
  public void setMu(int mu) {
    if (mu <= 0) {
      throw new IllegalArgumentException(
          String.format(
              "Mu value '%d' is invalid. Mu value must have a value of one or greater. "
  ...
  /**
   * Sets the lambda value in given parameters to the new given value. If lambda value is invalid a
  ...
  public void setLambda(int lambda) {
    if (lambda <= 0) {
      throw new IllegalArgumentException(
          String.format(
              "Lambda value '%d' is invalid. Lambda value must have a value of one or greater. "
  ...
  /**
   * Sets the evolutionary strategy given in parameters to '+' or ','. If an invalid option is given
   * a warning is displayed and the evolutionary strategy is left unchanged.
   */
  ...
  /**
   * Sets the mutation rate given in parameters. If an invalid mutation rate is given a warning is
   * displayed and the mutation rate is left unchanged.
   */
  ...
  /**
   * Sets the recurrent connection probability given in parameters. If an invalid value is given a
  ...
  /**
   * Sets the whether shortcut connections are used. If an invalid value is given a warning is
   * displayed and the value is left unchanged.
   */
  ...
  public void setUpdateFrequency(int updateFrequency) {
    if (updateFrequency < 0) {
      throw new IllegalArgumentException(
          String.format(
              "Warning: update frequency of %d is invalid. Update frequency must be >= 0. "
  ...
  /**
   * sets the fitness function to the fitnessFuction passed. If the fitnessFunction is NULL then the
   * default supervisedLearning fitness function is used.
   */
  ...
  /**
   * sets the selection scheme used to select the parents from the candidate chromosomes. If the
   * selectionScheme is NULL then the default selectFittest selection scheme is used.
   */
  ...
  public void initialiseDataSet(
      @NonNull double[][] input,
      @NonNull double[][] output,
      int numSamples,
      int numInput,
      int numOutput) {
  ...
  /**
   * if node needs for continues training, then should not remove inactive nodes
   *
  ...
  /**
   * Adds the give pre-defined functions to the given function set. The functions must be given in
   * the char array. The function names must be comma separated and contain no spaces i.e. "and,or".
   */
