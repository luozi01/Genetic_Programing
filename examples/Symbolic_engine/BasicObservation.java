...
public class BasicObservation implements Observation, Serializable {
    ...
    @Override
    public void setPredictedOutput(int index, String value) {
        predictedTextOutputs[index] = value;
    }
    ...
    @Override
    public double getPredictedOutput(int index) {
    ...
    public String getTextOutput(int index) {
        return textOutputs[index];
    }

    @Override
    public String getPredictedTextOutput(int index) {
        return predictedTextOutputs[index];
    }
}
